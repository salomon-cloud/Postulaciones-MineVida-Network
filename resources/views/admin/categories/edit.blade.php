                        ...
                        <div class="lg:col-span-2 rounded-lg border border-white/10 bg-white/[.025] p-4">
                            <div class="grid gap-4 md:grid-cols-[220px_1fr] md:items-center">
                                ...
                                <div>
                                    ...
                                    <p class="mt-2 text-xs leading-5 text-slate-500">Sube una nueva imagen para reemplazar la actual. Recomendado 1200x520 o similar; se ajusta completa dentro de la tarjeta para evitar cortes. JPG, PNG o WEBP, maximo 4 MB.</p>
