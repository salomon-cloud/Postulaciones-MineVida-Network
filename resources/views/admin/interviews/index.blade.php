        ...
        <div class="lumoryx-panel overflow-hidden">
            ...
            <div class="divide-y divide-white/10">
                @forelse ($upcoming as $interview)
                    <a href="{{ route('admin.applications.show', $interview->application) }}" class="d-block p-5 transition hover:bg-white/[.04]">
                        <div class="d-flex flex-column gap-4 flex-lg-row align-items-lg-center justify-content-lg-between">
                            ...
                            <div class="flex-shrink-0 rounded-lg border border-sky-300/20 bg-sky-300/10 px-4 py-3 text-sm text-sky-100">
